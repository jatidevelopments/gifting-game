      ...
      <header className="relative z-20">
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            {/* Language Switcher and Blog Link - Right aligned */}
            <div className="flex items-center space-x-4">
              <Link
                href="/blog"
                className="group flex items-center space-x-2 rounded-xl border border-gray-200 bg-white/90 px-4 py-2 text-sm font-bold text-gray-600 transition-all hover:-translate-y-0.5 hover:border-gray-300 hover:shadow-lg dark:border-gray-800 dark:bg-gray-900/90 dark:text-gray-300 dark:hover:border-gray-700 dark:hover:text-white"
              >
                <svg
